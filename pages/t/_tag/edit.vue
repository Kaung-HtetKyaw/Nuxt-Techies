<template>
  <div>
    <create-tag type="update" collection="tag" :params="{data:tag,id:tagID}">
              ...
              <div>
                ...
                <div class="pa-4">
                  ...
                  <div class="full-width d-flex flex-column justify-center align-center">
                    ...
                    <color-picker :color="tag.bg_color" @colorPick="setTextColor"></color-picker>
                  </div>
                  <div class="full-width d-flex flex-column justify-center align-center">
                    <h1
                      class="text-h6 text-md-h4 text-center font-weight-medium my-4"
                    >Select Logo Background Color</h1>
                    <color-picker :color="tag.text_color" @colorPick="setBackgroundColor"></color-picker>
                  </div>
                </div>
              </div>
            </v-col>
...
export default {
  ...
  async fetch() {
    const tag = this.getTagByID(this.tagID);
    this.tag = { ...tag };
  },
  methods: {
    createTag(callback) {
